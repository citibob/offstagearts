...
//{
//
//static final Map<String,String> States, Suffixes, Identifiers, Directionals, Numbers;
//
...
// * @stdAddr = string   the cleaned up string
// */
...
//}
//
//public static final int AT_STREET = 0;
//public static final int AT_RROUTE = 1;
//public static final int AT_POBOX = 2;
//public static final int AT_STREET = 3;
//
//String stdAddr;
//int addrType;
//
...
//public String number;			// Number on street, rural route, po box, etc.
//public String identifier;		// apt, etc.
//public String idNo;				// apt X?
//
//public StdAddr(String addr)
//{
//	String[] parts;
//	
//	if (addr == null || "".equals(addr)) stdAddr = "";
//
...
//			idNo = atom[8];
//			street = atom[2] + " COUNTY HWY";
//			number = atom[1];
//			stdAddr = number + street + " " + identifier + idNo;
//			return;
//		}
//		street = atom[2] + " COUNTY HIGHWAY " + atom[7] + ALS_EOL_Abbr(atom[8]);
//		number = atom[1];
//		stdAddr = number + street;
//		return;
//	}
//
...
//			number = atom[1];
//			street = atom[2] + " COUNTY RD " + atom[8] + atom[9];
//			stdAddr = number + street;
//			return;
//		}
//		number = atom[1];
//		street = atom[2] + " COUNTY ROAD " + atom[8] + ALS_EOL_Abbr(atom[9]);
//		stdAddr = number + street;
//		return;
//	}
//
...
//			atom[8] = s;
//			atom[9] = ereg_replace(" #", "", atom[9]);
//			street = atom[2] + " STATE RD " + atom[8] + atom[9];
//			number = atom[1];
//			stdAddr = number + street;
//			return;
//		}
//		number = atom[1];
//		street = atom[2] + "STATE ROAD " + atom[8] + ALS_EOL_Abbr(atom[9]);
//		stdAddr = number + street;
//		return;
//	}
//
...
//			atom[7] = s;
//			atom[8] = ereg_replace(" #", "", atom[8]);
//			street = atom[2] + " STATE RTE " + atom[7] + atom[8];
//			number = atom[1];
//			stdAddr = number + street;
//			return;
//		}
//		street = atom[2] + " STATE ROUTE " + atom[7] + ALS_EOL_Abbr(atom[8]);
//		number = atom[1];
//		stdAddr = number + street;
//		return;
//	}
...
//		number = atom[1];
//		street = "INTERSTATE " + atom[6] + ALS_EOL_Abbr(atom[7]);
//		stdAddr = number + " " + street;
//		return;
//	}
//
...
//			atom[7] = s;
//			atom[8] = ereg_replace(" #", "", atom[8]);
//			street = atom[2] + " STATE HWY " + atom[7] + atom[8];
//			number = atom[1];
//			stdAddr = number + street;
//			return;
//		}
//		street = atom[2] + " STATE HIGHWAY " + atom[7] + ALS_EOL_Abbr(atom[8]);
//		number = atom[1];
//		stdAddr = number + street;
//		return;
//	}
...
//			atom[7] = s;
//			atom[8] = ereg_replace(" #", "", atom[8]);
//			street = atom[2] + " US HWY " + atom[7] + atom[8];
//			number = atom[1];
//			stdAddr = number + street;
//			return;
//		}
//		street = atom[2] + " US HIGHWAY " + atom[7] + ALS_EOL_Abbr(atom[8]);
//		number = atom[1];
//		stdAddr = number + street;
//		return;
//	}
...
//			street = "RANCH RD " + atom[5] + atom[6];
//			number = atom[1];
//			stdAddr = number + street;
//			return;
//		}
//		street = "RANCH ROAD " + atom[5] + ALS_EOL_Abbr(atom[6]);
//		number = atom[1];
//		stdAddr = number + street;
//		return;
//	}
...
//		street = "ROAD " + atom[4] + ALS_EOL_Abbr(atom[5]);
//		number = atom[1];
//		stdAddr = number + street;
//		return;
//	}
...
//		atom[1] = ereg_replace("[*]", " ", atom[1]);
//		street = "ROUTE " + atom[4] + ALS_EOL_Abbr(atom[5]);
//		number = atom[1];
//		stdAddr = number + street;
//		return;
//	}
...
//		atom[1] = ereg_replace("[*]", " ", atom[1]);
//		street = atom[1] + "AVENUE " + atom[4] + ALS_EOL_Abbr(atom[5]);
//		number = atom[1];
//		stdAddr = number + street;
//		return;
//	}
...
//		atom[1] = ereg_replace("[*]", " ", atom[1]);
//		street = atom[1] + "BOULEVARD " + ALS_EOL_Abbr(atom[4] + atom[5]);
//		number = atom[1];
//		stdAddr = number + street;
//		return;
//	}
...
//System.out.println(ereg("(^([0-9]*)$)", parts[counter]));
//			int Prior = counter - 1;
//			int Next = counter + 1;
...
//	System.out.println("xxx " + AddressLineStandardization("12-23      south Wayland St. NE apartment 4"));
