 ...
 * @author citibob
 */
public class TicketNameWiz extends HtmlWiz {
	
/**
 * Creates a new instance of PersonWiz 
 */
public TicketNameWiz(java.awt.Frame owner, App app)
...
//	setSize(600,460);
	...
	TypedWidget startdate = app.swingerMap().newWidget(new JDay());
		startdate.setValue(today);
	addWidget("startdate", startdate);
