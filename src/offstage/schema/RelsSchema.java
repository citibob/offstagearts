...
public class RelsSchema extends ConstSqlSchema
{

public RelsSchema(citibob.sql.SqlRun str, DbChangeModel change)
throws SQLException
{
	super();
	table = "rels";
	...
	cols = new SqlCol[] {
		...
		new SqlCol(new SqlInteger(false), "entityid0", true),
